...
class Movie {
  ...
  String get completePosterPathW500 {
    return posterPath != null ? '${ApiEndpoint.imagePathW500}$posterPath' : '';
  }

  String get completeBackdropPathW500 {
    return backdropPath != null
        ? '${ApiEndpoint.imagePathW500}$backdropPath'
        : '';
  }

  String get completePosterPathOriginal {
    return posterPath != null
        ? '${ApiEndpoint.imagePathOriginal}$posterPath'
        : '';
  }

  String get completeBackdropPathOriginal {
    return posterPath != null
        ? '${ApiEndpoint.imagePathOriginal}$backdropPath'
        : '';
  }
}
